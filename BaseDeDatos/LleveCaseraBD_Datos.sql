...
insert into venta (fecha_venta, total_venta, estado_venta, cliente_id_cliente, vendedor_id_vendedor) values ('2020-07-07', 43, 1, 1, 1);
insert into venta (fecha_venta, total_venta, estado_venta, cliente_id_cliente, vendedor_id_vendedor) values ('2020-07-07', 40, 1, 2, 2);
insert into venta (fecha_venta, total_venta, estado_venta, cliente_id_cliente, vendedor_id_vendedor) values ('2020-07-08', 50, 1, 3, 1);
select * from venta;
